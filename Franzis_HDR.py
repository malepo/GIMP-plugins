...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "Franzis_HDR")
  ...
  command = "\"C:\\Program Files\\Franzis\\HDR projects 4\\HDR projects 4.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling Franzis HDR...")
...
register(
        "python_fu_FranzisHDR",
        "Call Franzis HDR",
        "Call Franzis HDR",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/HDR/Franzis HDR",
        "RGB*, GRAY*", 
