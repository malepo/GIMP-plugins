...
'''
Dfine2.py
call Nik's Collection's Analog Efex Pro 2 passing the active layer as a temp file. 
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "NIKAnalogEffects")
  ...
  command = "\"C:\\Program Files\\Google\\Nik Collection\\Analog Efex Pro 2\\Analog Efex Pro 2 (64-Bit)\\Analog Efex Pro 2.exe\"" + " \"" + tempfilename + "\""
...
register(
        "python_fu_analog_efex_pro",
        "Call Analog Efex Pro 2",
        "Call Analog Efex Pro 2",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Color/Nik Analog Efex Pro 2",
        "RGB*, GRAY*", 
