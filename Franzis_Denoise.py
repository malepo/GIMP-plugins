...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "Franzis_Denoise")
  ...
  command = "\"C:\\Program Files\\Franzis\\DENOISE projects standard\\DENOISE projects standard.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling Franzis Denoise...")
...
register(
        "python_fu_FranzisDenoise",
        "Call Franzis Denoise",
        "Call Franzis Denoise",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Denoise/Franzis Denoise",
        "RGB*, GRAY*", 
