...
'''
Dfine2.py
call Nik's Collection's Silver Efex Pro 2 passing the active layer as a temp file. 
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "NIKSilverEffects")
  ...
  command = "\"C:\\Program Files\\Google\\Nik Collection\\Silver Efex Pro 2\\Silver Efex Pro 2 (64-Bit)\\Silver Efex Pro 2.exe\"" + " \"" + tempfilename + "\""
...
register(
        "python_fu_silver_efex_pro",
        "Call Silver Efex Pro 2",
        "Call Silver Efex Pro 2",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Black and White/Nik Silver Efex Pro 2",
        "RGB*, GRAY*", 
