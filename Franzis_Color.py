...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "Franzis_Color")
  ...
  command = "\"C:\\Program Files\\Franzis\\COLOR projects 4\\COLOR projects 4.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling Franzis Color...")
...
register(
        "python_fu_FranzisColor",
        "Call Franzis Color",
        "Call Franzis Color",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Color/Franzis Color",
        "RGB*, GRAY*", 
