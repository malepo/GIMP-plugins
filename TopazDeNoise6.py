...
'''
Dfine2.py
call Topaz DeNoise 6 passing the active layer as a temp file. 
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "TopazDeNoise6")
  ...
  command = "\"C:\\Program Files\\Topaz Labs\\Topaz DeNoise 6\\tldenoise6.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling De Noise 6...")
...
register(
        "python_fu_Topaz_DeNoise_6",
        "Call Topaz DeNoise 6",
        "Call Topaz DeNoise 6",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Denoise/Topaz De Noise 6",
        "RGB*, GRAY*", 
