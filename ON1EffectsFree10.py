...
With the assumption having ON1 Effects Free 10 installed at defualt location 
in a 64 bit Version of Windows - tested with Windows 10
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "On1")
  ...
  # this assumes ON1 Effects Free 10 is installed to the defualt location
  # in windows 64bit
  command = "\"c:\\Program Files\\ON1\\ON1 Effects Free 10\\ON1 Effects Free 10.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling ON1 Effects Free 10...")
...
register(
        "python_fu_ON1EffectsFree10",
        "Call ON1 Effects Free 10",
        "Call ON1 Effects Free 10",
        "Martin Pohl",
        "Copyright 2016 Martin Pohl",
        "2016",
        "<Image>/Photography/Effects Free 10",
        "RGB*, GRAY*", 
