...
'''
Dfine2.py
call Topaz Texture Effects passing the active layer as a temp file. 
...
Version:
0.9 Made it specific to Topaz Collection
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "TopazTextureEffects")
  ...
  command = "\"C:\\Program Files\\Topaz Labs\\Topaz Texture Effects\\tltextureeffects.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling Texture Effects...")
...
register(
        "python_fu_Topaz_Texture_Effects",
        "Call Topaz Texture Effects",
        "Call Topaz Texture Effects",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Artistic/Topaz Texture Effects",
        "RGB*, GRAY*", 
