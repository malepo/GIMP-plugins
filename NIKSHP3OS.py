...
'''
Dfine2.py
call Nik's Collection's Sharpener Pro 3 Output Sharpening passing the active layer as a temp file. 
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "NIKSharpen")
  ...
  command = "\"C:\\Program Files\\Google\\Nik Collection\\Sharpener Pro 3\\Sharpener Pro 3 (64-Bit)\\SHP3OS.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling Sharpener Pro 3 Output Sharpening...")
...
register(
        "python_fu_sharpener_pro_OS",
        "Call Sharpener Pro 3 Output Sharpening",
        "Call Sharpener Pro 3 Output Sharpening",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Sharpen/Nik Sharpener Pro 3 Output Sharpening",
        "RGB*, GRAY*", 
