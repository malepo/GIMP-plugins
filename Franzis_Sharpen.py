...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "Franzis_Sharpen")
  ...
  command = "\"C:\\Program Files\\Franzis\\SHARPEN projects professional\\SHARPEN projects professional.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling Franzis Sharpen...")
...
register(
        "python_fu_FranzisSharpen",
        "Call Franzis Sharpen",
        "Call Franzis Sharpen",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Sharpen/Franzis Sharpen",
        "RGB*, GRAY*", 
