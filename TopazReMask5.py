...
'''
Dfine2.py
call Topaz ReMask 5 passing the active layer as a temp file. 
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "TopazReMask5")
  ...
  command = "\"C:\\Program Files\\Topaz Labs\\Topaz ReMask 5\\tlremask5.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling ReMask 5...")
...
register(
        "python_fu_Topaz_ReMask_5",
        "Call Topaz ReMask 5",
        "Call Topaz ReMask 5",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Masking/Topaz ReMask 5",
        "RGB*, GRAY*", 
