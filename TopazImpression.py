...
'''
Dfine2.py
call Topaz Impression passing the active layer as a temp file. 
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "TopazImpression")
  ...
  command = "\"C:\\Program Files\\Topaz Labs\\Topaz Impression\\tlimpression.exe\"" + " \"" + tempfilename + "\""
  args = shlex.split(command)

  # Invoke external command
  pdb.gimp_progress_set_text ("calling Impression...")
...
register(
        "python_fu_Topaz_Impression",
        "Call Topaz Impression",
        "Call Topaz Impression",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Artistic/Topaz Impression",
        "RGB*, GRAY*", 
