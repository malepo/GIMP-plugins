...
'''
Dfine2.py
call Nik's Collection's Dfine2 passing the active layer as a temp file. 
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "NIKDefine")
  ...
  pdb.gimp_progress_set_text ("calling Dfine2...")
...
register(
        ...
        "2011",
        "<Image>/Photography/Denoise/Nik Dfine2",
        "RGB*, GRAY*", 
