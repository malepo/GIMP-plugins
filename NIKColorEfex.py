...
'''
Dfine2.py
call Nik's Collection's Color Efex Pro 2 passing the active layer as a temp file. 
...
def plugin_main( image, drawable, visible ):
  ...
  if visible == 0:
    ...
    temp = pdb.gimp_layer_new_from_visible(image, image, "NIKColorEffects")
  ...
  pdb.gimp_progress_set_text ("calling Color Efex Pro 2...")
...
register(
        "python_fu_color_efex_pro",
        "Call Color Efex Pro 2",
        "Call Color Efex Pro 2",
        "Rob Antonishen",
        "Copyright 2011 Rob Antonishen",
        "2011",
        "<Image>/Photography/Color/Nik Color Efex Pro 2",
        "RGB*, GRAY*", 
